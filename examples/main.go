...
func main() {
	...
	keyDummy, _ := tag.NewKey("generator1")
	...
	ctx, _ := tag.New(context.Background(), tag.Insert(keyMethod, "repl"), tag.Insert(keyClient, "cli"), tag.Insert(keySource, "source1"), tag.Insert(keyDummy, "generator1"))
